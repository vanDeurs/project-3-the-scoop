...
function createComment(url, request) {
  ...
  if (requestComment && requestComment.username && database.users[requestComment.username] && requestComment.article) {
    const comment = {
...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    ...
    // const articleCommentIds = database.users[savedComment.username].articleId;
